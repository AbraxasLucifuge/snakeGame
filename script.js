...
class Snake{
    ...
    draw(){
        ...
        ctx.rect(this.tail[this.total-1].x,this.tail[this.total-1].y,tileSize,tileSize);
        ctx.fill()
    ...
    eatenTail(){
        for(let i=0;i<this.tail.length-1;i++){
            ...
            if(this.x + tileSize > this.tail[i].x &&
...
function stopGame(){
    ...
    setTimeout(() => {
        ...
        document.querySelector('.game-over-box .btn').addEventListener('click',()=>{
